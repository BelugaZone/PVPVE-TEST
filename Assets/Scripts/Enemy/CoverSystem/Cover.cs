...
public class Cover : MonoBehaviour
{
    ...
    private bool IsFutherestFromPlayer(CoverPoint coverPoint)
    {
        ...
        {
            float distance = Vector3.Distance(point.transform.position, GetPlayerTransform().position);
    ...
    {
        float distanceToPlayer = Vector3.Distance(coverPoint.transform.position, GetPlayerTransform().position);
    ...
    {
        return Vector3.Distance(coverPoint.transform.position, GetPlayerTransform().position) < 2;
    }
