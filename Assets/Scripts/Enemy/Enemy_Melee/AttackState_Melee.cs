...
public class AttackState_Melee : EnemyState
{
    ...
    public override void Enter()
    {
        ...
        enemy.SetAnimFloat("AttackAnimationSpeed", enemy.attackData.animationSpeed);
        enemy.SetAnimFloat("AttackIndex", enemy.attackData.attackIndex);
        enemy.SetAnimFloat("SlashAttackIndex", Random.Range(0, 6)); // we have 6 attacks with index from 0 to 5
    ...
    private void SetupNextAttack()
    {
        ...
        enemy.SetAnimFloat("RecoveryIndex", recoveryIndex);
